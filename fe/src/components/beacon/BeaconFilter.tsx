      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          >
            ...
            {topicOptions.map((topic) => {
              // support both string[] and { value, label }[] shapes
              const optValue = typeof topic === 'string' ? topic : topic.value;
              const optLabel = typeof topic === 'string' ? topic : topic.label;
        ...
        <div>
          ...
          >
            ...
            <option value={BeaconType.NORMAL}>Normal</option>
            <option value={BeaconType.URGENT}>Urgent</option>
          </select>
        </div>
      </div>
    </div>
