...
export class ApplicationsController {
    async applyToBeacon(
        ...
        try {
            ...
            const application = await applicationsService.applyToBeacon(
                beaconId,
                helperId,
                data
            );
    ...
    async getBeaconApplications(
        ...
        try {
            ...
            const applications = await applicationsService.getBeaconApplications(
                beaconId,
                userId
            );
    ...
    async selectHelper(
        ...
        try {
            ...
            const userId = req.user!.userId;
            const session = await applicationsService.selectHelper(
                applicationId,
                userId
            );
